...
<input type="text" name="installpass" />&nbsp;&nbsp;<input type="submit" name="submit1" value="Submit">
{% elseif success == 1 %}
...
<input type="text" name="password" /><br />&nbsp;&nbsp;<input type="submit" name="submit2" value="Submit">
{% elseif success == 2 %}
